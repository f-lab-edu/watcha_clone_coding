...
export const fetchPopularMovieList = () => 
  instance
    .get(`/movie/popular?${movieListQueryString}`)
...
export const fetchMovieDetail = (movieId: string) => 
  instance
    .get(`/movie/${movieId}?${movieDetailQueryString}`)
    .then((response) => {
...
export const fetchTodayTrendingMovie = () => 
  instance
    .get(`/trending/movie/day?${movieTrendingQueryString}`)
    .then((response) => response.data.results);
...
export const fetchMovieGenres = () => 
  instance 
    .get(`/genre/movie/list?${movieGenresQueryString}`) 
